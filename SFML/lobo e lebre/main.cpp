...
sf::Texture rock_tex { loadTexture("img/rock.png")};

Entity rock(5, 3, STEP, rock_tex);
...
bool colide(Entity& entity){
    if(entity.x == rock.x && entity.y == rock.y){
        return true;
    }
    return false;
}
...
int main() {
    ...
    sf::Texture wolf_tex { loadTexture("img/lobol.png") };
    sf::Texture rabbit_tex { loadTexture("img/coelho.png") };
    sf::Texture grass_tex { loadTexture("img/grama.jpg") };
