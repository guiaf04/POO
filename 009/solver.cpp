...
public:
    ...
    PtrKid removeKid(std::string name) {
      ...
      if(removeFromList(name, this->waiting) != nullptr){
        removed = removeFromList(name, this->waiting);
      }else if (removeFromList(name, this->playing) != nullptr){
        removed = removeFromList(name, this->playing);
      }
